...
<body>
	...
	<div style="width: 100px; height:10%; padding: 10px;">
		<input type="text" id="message" size="110" onkeypress="if(event.ketCode==13){webSocket.sendChat();}" />
