        ...
        <body>
            ...
            <div id="container">
                <form action="/board/update" method="post">
                    ...
                    쓴날짜 : <input type="text" class="first" value= "${board.regdate}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    마지막 수정날짜 : <input type="text" class="last" value= "${board.updatedate}"/> <br/><br/>
                    ...
                    <input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }" />
                    <input type="submit" class="submit" value="수정"/>&nbsp;&nbsp;&nbsp;<input type="reset" class="reset" value="초기화"/>
                </form>
            </div>
