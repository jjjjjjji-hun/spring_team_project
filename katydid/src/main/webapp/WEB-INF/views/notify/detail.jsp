        ...
        <body>
            ...
            <div id="container">
                ...
                <div class="container2">
                    ...
                    <button type="button" class="btn btn-secondary" onclick="location.href='/notify/list'">공지사항 목록 가기</button>
                    &emsp;&emsp;<button type="button" class="btn btn-light " onclick="location.href='/'">메인가기</button>
                    </div>
                </div>    
            </div>
